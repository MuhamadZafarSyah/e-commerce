<!-- Navbar -->
<nav class="relative bg-white dark:bg-darker">
    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
        ...
        <nav x-transition:enter="transition duration-200 ease-in-out transform sm:duration-500"
            ...
            class="absolute flex items-center p-4 bg-white rounded-md shadow-lg dark:bg-darker top-16 z-50 inset-x-4 md:hidden"
            ...
            <div x-data="{ isActive: true, open: true }">
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                    ...
                    <a href="/admin/dashboard/product" role="menuitem"
                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700 {{ Request::is('admin/dashboard/product*') ? 'dark:text-white text-black' : '' }}">
                        Product
                    </a>
